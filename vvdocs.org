...
- *all_demos*: A script that runs all the demos and saves the plots to an HTML file.
...
- *geos(sim_data: Dict[str, Any], n: int, fov: float)*: Creates `n` equally spaced satellites in GEO and adds them to the simulation.
