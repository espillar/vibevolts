...
\begin{enumerate}
    ...
    \item \textbf{Detectors:} A blank \texttt{DetectorArray} is initialized and appended to \texttt{sim\_data.detector}. Specific sensor parameters (FOV, aperture, zero points, integration times) are populated via \texttt{makeDetector()}.
