...
\begin{itemize}
    ...
    \item \textbf{Configuration:} The user configures these detectors (e.g., using \texttt{makeDetector()}), setting crucial parameters like Field of View (FOV), integration time, and the Earth exclusion angle (\texttt{earthEx}), which serves as the local horizon limit.
\end{itemize}
