...
** Details
*** Coding [12/26]
**** Get a simple search pattern going [4/12]
- [X] Review that your targets are defined and have sizes
- [X] add radii and types to your targets
- [X] Check that you have targets with sizes- what are they again? Review, make
  a section in documentation - I don't think fixedpoints has the right stuff in it
- [X] clean up extraneous links to fixedpoints
- [ ] update the time - do I need a function that does this?
- [ ] update sensor fields of view
...
- [ ] create a function that creates a matrix satellites and targets
- [ ] create a simulation skeleton you are going to work with
- [ ] create function that takes a satellite and the targets and determines all
  of the SNRs 
