...
** Details
*** Coding [12/26]
**** Get a simple search pattern going [5/8]
- [X] Basic pointing iteration working
- [X] Code review-review what your are doing and make sure it's documented
- [X] have gemini write something to display what the jumping around looks like
- [X] jump over missing exclusions until you can see something
- [X] make a new demo that plots what's going on somehow
- [ ] Check that you have targets with sizes- what are they again? Review, make
  a section in documentation - I don't think fixedpoints has the right stuff in it
- [ ] clean up extraneous links to fixedpoints
