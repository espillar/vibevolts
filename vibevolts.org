...
**** Today's ad-hoc checklist [3/11]
- [X] recreate todays list
- [X] fix the detectorVect in scandetectors
- [X] why is detectorVect not set up? See below
- [ ] Remove any default creation of pointing_spheres
- [ ] I need a function like "pointingInit"
- [ ] Set up pointing spheres
- [ ] follow the example in constellation to initialize detectors
- 
- [ ] how is it right in the demos?
- [ ] Continue stepping through scandetectors, using jupyter for the moment,
  fixing a line at a time. Just check what you have is right.
- [ ] outline what we need to do in comments in scandetectors.py
- [ ] build better links between detectors and satellites - started with
  1:1, we need [0,1]:n
