...
** Details
*** Coding [12/26]
**** subtasks for the next big item [1/2]
- [X] Mess around and install ipython/anaconda as an emacs tool
- [ ] why are the targets in an array or something instead of one big numpy? fix it. 
