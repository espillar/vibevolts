...
- cadenceController.py
  ...
  - nextGroup - find and performs the next scan
  
- cadenceStructure - holds the data for scanController
  - nextTime, nextGroup 
  - cadenceList (a numbered list)
    - cadenceGroup (a structure)
      - aScan 
	- scanMask
	- scanInterval
	- scanNext
...
- create an empty scanSets structure 
- take the for each item in the set (local)
  - create an empty aScan
