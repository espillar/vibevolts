...
- [ ] look at the function that creates a constellation. One of it's arguments should be a limiting magnitude, and it should create an integration time for that.
...
- [X] Review the documentation we have and improve it a little by adding
  the plotting functions to the documentation

OK work in the morining, at least starting to focus, but yak shaving.
Let's get on with it after lunch at 1430
