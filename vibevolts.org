...
at the end. Probably go there and see what's going on.
I should make the size of the  array not a constant 9 or 11, but  constant
defined in cnstants.py and propagate that.
*** [2025-11-02 Sun]
